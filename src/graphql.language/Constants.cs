...
public static class Constants
{
    ...
    public static ReadOnlyMemory<byte> Bom = new(
    ...
    public static ReadOnlyMemory<byte> BlockString = new(new[]
    {
        Quote,
        Quote,
        Quote
    ...
    public static ReadOnlyMemory<byte> ReturnAndNewLine = new(new[]
    {
        Return,
        NewLine
    });

    public static ReadOnlyMemory<byte> NewLineMemory = new(new[]
    {
        NewLine
    });

    public static ReadOnlyMemory<byte> Punctuators = new(new[]
    {
        ExclamationMark,
        Dollar,
        Ampersand,

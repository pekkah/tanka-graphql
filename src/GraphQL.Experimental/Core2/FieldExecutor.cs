...
namespace Tanka.GraphQL.Experimental.Core2
{
    ...
    {
        public CoerceArgumentValues CoerceArgumentValues { get; }
        public ResolveFieldValue ResolveFieldValue { get; }
        public SerializeValue SerializeValue { get; }
        ...
        public async Task<object?> ExecuteField(

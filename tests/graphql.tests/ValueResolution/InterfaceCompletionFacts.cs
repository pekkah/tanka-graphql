...
namespace Tanka.GraphQL.Tests.ValueResolution
{
    public class InterfaceCompletionFacts
    {
        ...
        public async Task Should_fail_if_no_ActualType_given()
        {
            ...
            /* Then */
            Assert.Equal("Cannot complete value for field 'field':'Character'. ActualType is required for interface values.", exception.Message);
        }
        ...
        public async Task Should_fail_if_ActualType_is_not_possible()
        {
            ...
            /* Then */
            Assert.Equal("Cannot complete value for field 'field':'Character'. ActualType 'Human' does not implement interface 'Character'", exception.Message);
        }

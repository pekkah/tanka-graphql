...
public class PrinterFacts
{
    ...
    public void Argument(string source, Type valueType)
    {
    ...
    public void Value_BlockString(string source)
    {
        ...
        AssertPrintedEquals(parsedSource, actual);
    }
    ...
    public void Value_ObjectValue_ObjectField(string source, Type typeOf)
    {
        var node = Parser.Create(source)
            .ParseObjectValue();
    ...
    public void OperationDefinition_With_Comment_After_Selection()
    {
        ...
        /* Then */
        AssertPrintedEquals("query { field }", actual);
    }
    ...
    public void OperationDefinition_With_Comment_Between_Selections()
    {
        ...
        /* Then */
        AssertPrintedEquals("query { field1 field2 }", actual);
    }

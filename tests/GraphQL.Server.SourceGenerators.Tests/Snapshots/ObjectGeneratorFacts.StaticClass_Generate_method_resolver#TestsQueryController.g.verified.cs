...
public static class QueryController
{
    ...
    {
        context.ResolvedValue = Query.Id(context.GetArgument<int?>("p1"));
        return default;
    }
}
...
public static class QueryControllerExtensions
{
    ...
    {
        builder.Builder.Configure(options => options.Builder.Add("Query", new FieldsWithResolvers() { { "id(p1: Int): Int!", QueryController.Id } }));
        return builder;
    }
}
#nullable restore
